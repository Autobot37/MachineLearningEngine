...
Original file is located at
    https://colab.research.google.com/drive/1Y75a03xygs-LzKMEr1_lGJc7yxKcuQIH
"""
...
#@title
Tokenizer.train(input="C:\\Users\\SHIVA SINGH\\OneDrive\\Documents\\LLM\\data\\input.txt",destination="C:\\Users\\SHIVA SINGH\\OneDrive\\Documents\\LLM\\pl\\tokenizer")

#@title
enc = Tokenizer("C:\\Users\\SHIVA SINGH\\OneDrive\\Documents\\LLM\\pl\\tokenizer\\tokenizer.model")
...
dm  = DataModule("C:\\Users\\SHIVA SINGH\\OneDrive\\Documents\\LLM\\data" ,config=config,trainer=trainer)
...
class Trainer:
  def __init__(self,config,model,datamodule):
    ...
    self.dm = datamodule(dir_path="C:\\Users\\SHIVA SINGH\\OneDrive\\Documents\\LLM\\data",config=self.config,trainer=self.fabric)
