...
def main():
  ...
  parser.add_argument('-n','--nodes',default=1,type=int,metavar='N')#total nodes
  parser.add_argument('-g','--gpus',default=1,type=int,help="number of gpus per node")#pER NODE GPU
  parser.add_argument('-nr','--nr',default=-1,type=int,help='ranking within nodes')#NO OF NODE
  parser.add_argument('--epochs',default=2,type=int,metavar='N')#TOTAL EPOCHS GLOBALLY

  args = parser.parse_args()

  args.world_size = args.gpus * args.nodes #TOTAL PROCESS LOCAL RANK IS THIS RANK
  os.environ['MASTER_ADDR'] = '127.57.23.164'
  os.environ['MASTER_PORT'] = '8101'
